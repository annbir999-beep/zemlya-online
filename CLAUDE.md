...
- **AVITO/CIAN — не лоты** — это рыночные предложения для сравнения цен, на карте их быть не должно. Старая грабля «покрытие карты 6.5% из-за AVITO без КН» неактуальна: карта считается только по torgi.gov (~84% с координатами на 09.07.2026).
