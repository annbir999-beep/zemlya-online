      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 16, color: "var(--text-2)", maxWidth: 640, margin: "0 auto", lineHeight: 1.6 }}>
            ...
            участвуем в торгах и доводим до подписания договора. Вы получаете результат —
        ...
        <div style={{ ...card, marginBottom: 20, borderColor: "var(--primary)" }}>
          ...
          <p style={{ color: "var(--text-2)", fontSize: 14, lineHeight: 1.65, marginBottom: 14 }}>
            ...
            стратегия и участие в аукционе → подписание договора.
          </p>
        ...
        <div style={{ ...card, marginBottom: 20 }}>
          ...
          <p style={{ color: "var(--text-2)", fontSize: 14, lineHeight: 1.65, marginBottom: 14 }}>
            Государство предоставляет 1 га на человека (до 5 га на семью) без выкупа — платите только
            за наше сопровождение. Большинство заявок буксует из-за ошибок: неверный контур, пересечение
            с лесфондом, слабый план освоения. Мы делаем правильно с первого раза.
          </p>
          <ul style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.9, margin: "0 0 16px 18px", padding: 0 }}>
        ...
        <div style={{ ...card, marginBottom: 20, background: "linear-gradient(135deg, var(--surface), rgba(202,138,4,0.06))" }}>
          ...
          <p style={{ color: "var(--text-2)", fontSize: 14, lineHeight: 1.65, marginBottom: 18 }}>
            ...
            математика сделки сильнее. Три формата сотрудничества:
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14, marginBottom: 16 }}>
            ...
            <div style={{ border: "1px solid var(--border)", borderRadius: 10, padding: 16 }}>
              ...
              <div style={{ fontSize: 13, color: "var(--text-2)", lineHeight: 1.6 }}>
                Целевая ставка оговаривается по каждому лоту (ориентир — до 30% годовых). Инвестирование
                через лицензированную инвестиционную платформу (ЦБ РФ): низкий порог входа — от 10–100 тыс ₽,
                чёткий срок выхода, обеспечение — сам участок (обременение до реализации).
              </div>
            </div>
            <div style={{ border: "1px solid var(--border)", borderRadius: 10, padding: 16 }}>
