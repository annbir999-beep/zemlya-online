    ...
    <div style={{ flex: 1, overflow: "auto" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <p style={{ fontSize: 17, color: "var(--text-2)", lineHeight: 1.65, marginBottom: 28 }}>
          ...
          отдельная работа. Её беру на себя.
        </p>
        ...
        <div style={{ ...card, marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 13, color: "var(--text-2)", marginTop: 14, lineHeight: 1.5 }}>
            ...
            в том же регионе — методику показываю целиком, без «до 90%».
          </div>
        </div>
        ...
        <ol style={{ paddingLeft: 22, lineHeight: 1.7, fontSize: 16, color: "var(--text)" }}>
          ...
          <li><b>Подбираю варианты.</b> Из всех действующих аукционов региона — те, что подходят,
            с расчётом скидки к рынку и оценкой ликвидности.</li>
          <li><b>Проверяю каждый.</b> Кадастр, вид разрешённого использования, обременения,
            охранные зоны, условия договора: срок аренды, переуступка, субаренда.</li>
          <li><b>Сопровождаю торги.</b> Задаток, электронная подпись, аккредитация на площадке,
        ...
        <div style={{ display: "grid", gap: 16, gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
          ...
          <div style={{ ...card, borderColor: "var(--primary)" }}>
            ...
            <div style={{ color: "var(--text-2)", lineHeight: 1.6, fontSize: 15 }}>
              ...
              Не выиграли торги — половину фикса возвращаю.
            </div>
          </div>
        </div>
        ...
        <p style={{ fontSize: 13.5, color: "var(--text-2)", marginTop: 22, lineHeight: 1.6 }}>
          Веду сама: ИП Бирюкова А. И. Работаю с электронными площадками и подаю заявки
          лично, а не пересказываю теорию из курсов.
        </p>
      </div>
    </div>
  );
