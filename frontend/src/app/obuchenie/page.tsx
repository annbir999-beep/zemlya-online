...
const LESSONS = [
  ...
  },
  {
    ...
    points: [
      ...
      "Дальше — межевание (если нужно), закрепление границ участка на местности и начало освоения.",
  ...
  {
    n: 6,
    title: "Бесплатный гектар: Дальний Восток и Арктика",
    time: "1 мин",
    points: [
      "Государство раздаёт землю бесплатно — по гектару на человека на Дальнем Востоке и в Арктике.",
      "Но семь из десяти заявок буксуют: контур участка задевает лесфонд или к нему нет дороги.",
      "Мы проверяем участок и подъездные пути заранее и готовим план освоения с первого раза.",
      "Гектар бесплатный — ошибки при оформлении дорогие. Возьмите нас в сопровождение.",
    ],
    cta: { href: "/services", label: "Сопровождение под ключ →" },
  },
];
