...
LEAD_STEPS = {
    ...
    1: ("Как найти выгодный лот за минуту — Торги Земли", _day1),
    3: ("Один пункт чеклиста спас 600 000 ₽ — Торги Земли", _day3),
    5: ("Скидка −25% на первый AI-аудит лота — Торги Земли", _day5),
    8: ("Первый аудит бесплатно при регистрации — Торги Земли", _day8),
}
