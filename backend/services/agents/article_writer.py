...
ARTICLE_PROMPT = """Ты — редактор блога сервиса «Торги Земли» (агрегатор земельных аукционов РФ с AI-оценкой участков).
...
GATE_PROMPT = """Сервис «Торги Земли» — агрегатор ЗЕМЕЛЬНЫХ аукционов: участки, аренда и выкуп земли, ЗК РФ, кадастр, ИЖС/СНТ/сельхоз.
Новость:
{title}
{summary}
